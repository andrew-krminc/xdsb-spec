...
public class DocumentRepositoryService extends Service {
    ...
    static {
        URL url = DocumentRepositoryService.class.getClassLoader().getResource("xds/XDSb.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(DocumentRepositoryService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "classpath:xds/XDSb.wsdl");
        }       
        WSDL_LOCATION = url;   
    }
